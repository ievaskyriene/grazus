...
class CashasJsonDb
{
    ...
    public function __construct() {
        ...
        $this->data = json_decode(file_get_contents('/opt/lampp/htdocs/grazus/Uzdaviniai/composer/app/data.json'), 1);
    }
    ...
    private function save() {
        file_put_contents('/opt/lampp/htdocs/grazus/Uzdaviniai/composer/app/data.json', json_encode($this->data));
    }
