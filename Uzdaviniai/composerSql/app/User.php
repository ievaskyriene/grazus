...
class User
{
    ...
    public static function createNew(){
        ...
        if(isset($_POST["action"]) && !empty($_POST)) {
            ...
            // move_uploaded_file($_FILES["cat_photo"]["tmp_name"], '/opt/lampp/htdocs/grazus/Uzdaviniai/composerSql/img/kaciukas1.jpeg');//nuotrauka
            // $cat = file_get_contents('/opt/lampp/htdocs/grazus/Uzdaviniai/composerSql/img/kaciukas1.jpeg');// nuotrauka
